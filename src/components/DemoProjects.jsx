          ...
          >
            ...
            {activeTab === "cybersecurity" && (
              ...
              >
                ...
                >
                  <div
                    className="absolute inset-0 flex items-center justify-center bg-red-600/80 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    id="el-c5nshsqt"
                  >
                    <div className="text-center p-4" id="el-awox83gt">
                      <p className="font-bold mb-2" id="el-ik65sxfp">
                        View Demo
                      </p>
                      <svg
                ...
                <div className="p-6" id="el-v45pouw4">
                  <div
                  ...
                  >
                    ...
                    <span
                      className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300"
                      id="el-dwk0gtqi"
                    >
                      Cybersecurity
                    </span>
                  ...
                  <div className="flex flex-wrap gap-2 mb-5" id="el-4ywm3z6p">
                    <span
